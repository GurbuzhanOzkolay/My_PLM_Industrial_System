...
namespace plm_api.Migrations
{
    ...
    [Migration("20260615140328_FixProductTreeTable")]
    partial class FixProductTreeTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("plm_api.ProductTree", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("plm_api.ProductTree", b =>
                {
                    b.HasOne("Products", "ChildProduct")
                        .WithMany()
                        .HasForeignKey("ChildProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Products", "ParentProduct")
                        .WithMany()
